...
//            console.log("supportsTouch: ", supportsTouch);
            ...
            if (!supportsTouch) {
                var x, left, down, newX, oldX, maxScrollLeft, am, amX, amL, leftElem, rightElem, currx, items, element,
                    elements;
                element = $(this);
                ...
                $(".g-scrolling-carousel .items .feid-button-switch-item").bind("click", function (value, index) {

                    console.log("click item");
                    let xPotitionLeft = $(this).position().left;
                    let xWidth = $(this).width();

                    // let xParent = $(parent).position().left;
                    let parentWidth = $(this).parent('.items').width();

                    let xTotal = (xPotitionLeft + xWidth / 2);

                    let d = xTotal - parentWidth / 2;
                    $(this).parent('.items').animate({scrollLeft: '+=' + d}, 200);

                    // $(".g-scrolling-carousel .items .feid-button-switch-item").removeClass('active');
