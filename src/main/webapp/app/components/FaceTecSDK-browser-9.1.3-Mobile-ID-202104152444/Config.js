export var Config = (function () {
    ...
    var DeviceKeyIdentifier = "dSn1o41xeuCUVZLCziabWDgVJNPplm2T";
    ...
    function initializeFromAutogeneratedConfig(FaceTecSDK, callback) {
        ...
        var obj = "{'expiryDate':'1637993110','key':'dAXO7Snnhtwx61y6ZEMQhsqn7P5N2UUn'}";

        // FaceTecSDK.setFaceTecLoggingMode(0)
        FaceTecSDK.initializeInProductionMode(obj,this.DeviceKeyIdentifier, this.PublicFaceScanEncryptionKey,
            function (initializedSuccessfully) {
            console.log("initializedSuccessfully",initializedSuccessfully);
                callback(initializedSuccessfully);
            });
    ...
    function retrieveConfigurationWizardCustomization(FaceTecSDK) {
        var sdkImageDirectory = "./app/components/FaceTecSDK-browser-9.1.3-Mobile-ID-202104152444/core-sdk/FaceTec_images/";
        ...
        var yourAppLogoImage = sdkImageDirectory + "remote-signing.png";
        ...
        // defaultCustomization.initialLoadingAnimationCustomization.backgroundColor = "transparent";
        defaultCustomization.initialLoadingAnimationCustomization.foregroundColor = "#3d3636";
        defaultCustomization.initialLoadingAnimationCustomization.messageTextColor = "#3d3636";
        defaultCustomization.initialLoadingAnimationCustomization.messageFont = "\"Montserrat\", \"Times New Roman\", Times, serif";
        ...
        // defaultCustomization.overlayCustomization.brandingImage = false;
