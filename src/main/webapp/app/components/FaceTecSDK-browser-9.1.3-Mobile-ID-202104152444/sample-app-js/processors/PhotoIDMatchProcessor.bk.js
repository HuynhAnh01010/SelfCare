...
var PhotoIDMatchProcessor = /** @class */ (function () {
    function PhotoIDMatchProcessor(sessionToken, sampleAppControllerReference,EIdentityService) {
    ...
    PhotoIDMatchProcessor.prototype.processSessionResultWhileFaceTecSDKWaits = function (sessionResult, faceScanResultCallback) {
        ...
        console.log(this.eIdentityService );
        //
        ...
        // this.latestNetworkRequest.open("POST", "https://localhost:8643/selfcare/api/e-identity/v1/processes/create");
